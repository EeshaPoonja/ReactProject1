 ...
 setmsh(!msh);
  ...
  return (
    ...
    <div className='all'>
      ...
      <button  className='butdownl' class="tooltip" data-tooltip="Download" onClick={ downloadCanvasImage}>   <DownloadIcon fontSize="medium" /></button>
      <button  className='butsave' class="tooltip" data-tooltip="Save" onClick={save}><SaveIcon fontSize="medium" /></button>

      <button  className='butopen'class="tooltip" data-tooltip="Open" onClick={opend}><FileOpenIcon fontSize="medium" /></button>

      

    
    
       <button  className='but2'class="tooltip" data-tooltip="Erase" onClick={erasedone}><ClearIcon fontSize="medium"/></button>
       <button  className='but3' class="tooltip" data-tooltip="Clear Screen" onClick={clearscreen}><DeleteForeverRoundedIcon fontSize="medium" /></button>
 

       <button className='butnotes' class="tooltip" data-tooltip="Add notes" onClick={addnotes}><NoteAddIcon fontSize="medium"/></button>
       <button className='but6' class="tooltip" data-tooltip="Add image" onClick={image}><ImageIcon fontSize="medium"/></button>
    
       <button className='buts' class="tooltip" data-tooltip="Add Shapes" onClick={shapes}><ShapeLineIcon fontSize="medium"/></button>
     
       
     
       {shoulddisplay && (<div className='colu'>
       <button className='but1' class="tooltip" data-tooltip="Rectangle" onClick={create_rect}><RectangleOutlinedIcon fontSize="medium"/></button>
       <button className='but4' class="tooltip" data-tooltip="Circle" onClick={create_circle}><Brightness1OutlinedIcon fontSize="medium"/></button>
       <button className='but8' class="tooltip" data-tooltip="Square" onClick={create_square}><SquareOutlinedIcon fontSize="medium"/></button>
       <button className='but5'class="tooltip" data-tooltip="Line" onClick={create_Line}><HorizontalRuleOutlinedIcon fontSize="medium"/></button>
      
       </div>)}
       <button  className='but0'class="tooltip" data-tooltip="Pen" onClick={pen}><EditIcon fontSize="medium"/></button>
       ...
       <button  id='buthelp' class="tooltip" data-tooltip="help" onClick={help}><HelpIcon fontSize='medium'/></button>
       </div>
